...
fun ProfileScreen(
        ...
        ProfileSectionLayout(
            ...
            Row {
                ChirpAvatarPhoto(
                    ...
                    onClick = { onAction(ProfileAction.OnUploadPictureClick) },
                )
                ...
                FlowRow(
                    ...
                    ChirpButton(
                        ...
                        onClick = { onAction(ProfileAction.OnDeletePictureClick) },
    ...
    if (state.showDeleteConfirmationDialog) {
        DestructiveConfirmationDialog(
            ...
            onConfirmClick = { onAction(ProfileAction.OnConfirmDeletePictureClick) },
            onCancelClick = { onAction(ProfileAction.OnDismissDeleteConfirmationDialogClick) },
            onDismiss = { onAction(ProfileAction.OnDismissDeleteConfirmationDialogClick) },
        )
    }
}
