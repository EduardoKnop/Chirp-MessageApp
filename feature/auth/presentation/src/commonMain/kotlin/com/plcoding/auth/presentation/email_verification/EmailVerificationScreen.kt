...
import com.plcoding.core.designsystem.components.brand.ChirpFailedIcon
...
import com.plcoding.core.designsystem.layout.ChirpSimpleResultLayout
...
@Preview
@Composable
private fun EmailVerificationErrorScreenPreview() {
    ChirpTheme {
        EmailVerificationScreen(
            state = EmailVerificationState(),
            onAction = { },
...
@Preview
@Composable
private fun EmailVerificationVerifyingScreenPreview() {
    ChirpTheme {
        EmailVerificationScreen(
            state = EmailVerificationState(
                isVerifying = true,
